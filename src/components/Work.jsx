...
import WorkImg1 from "../assets/Dictionary-React-App.png";
import WorkImg2 from "../assets/React-Weather-App.png";
import WorkImg3 from "../assets/World-Clock-app.png";

const Work = () => {
  return (
    <div
      name="work"
      className="w-full md:h-screen bg-gray-800 text-gray-300"
    >
